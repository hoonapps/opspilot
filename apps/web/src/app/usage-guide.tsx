...
const usageSteps = [
  ...
  {
    title: "청킹과 검색 품질 확인",
    body: "문서 화면에서 청크 커버리지와 헤딩 보존을 확인하고, 검색 화면에서 답변 생성 전에 후보 청크, 점수 격차, 출처 다양성, 컨텍스트 예산 포함 여부를 확인합니다.",
...
const checklist = [
  ...
  },
  {
    ...
    body: "문서 화면의 색인 품질 리포트와 청크 미리보기, 검색 화면의 후보 청크 순위에서 실제 청크, 점수, 권한 차단 결과, 컨텍스트 예산 포함 여부를 확인합니다."
  },
  {
