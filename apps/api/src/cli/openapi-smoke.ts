...
const REQUIRED_OPERATIONS: Array<{ path: string; method: HttpMethod; operationId?: string }> = [
  ...
  { path: "/documents/index-snapshot", method: "get", operationId: "DocumentsController_getIndexSnapshot" },
  ...
  { path: "/answers/{id}/claim-support", method: "get" },
  ...
  { path: "/evaluations/retrieval", method: "get" },
  { path: "/evaluations/embedding-comparison", method: "get" },
