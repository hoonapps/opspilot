...
- `/ask` API와 출처 포함 답변
- 검색 품질 진단, 점수 격차, 출처 다양성, 컨텍스트 예산 preview
...
- Search: pgvector 기본, Elasticsearch 선택형 하이브리드 검색
...
문서 화면은 문서 목록, 청크 수, 마스킹 수, 프롬프트 주입 격리 여부, 버전 변경 차이, 청크 미리보기, BullMQ 색인 큐 상태, 권한 매트릭스, 신규 문서 검색 검증 결과를 보여줍니다.
