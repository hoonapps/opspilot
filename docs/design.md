...
- `docs/assets/opspilot-portfolio-readiness.png`: RAG, 권한, 도구 호출, 운영성, 데모 산출물을 서버 집계로 보여주는 제품 증거 보드
- `docs/assets/opspilot-audit-ledger.png`: 질문, 답변, 도구 호출, 승인, 피드백 이벤트를 SHA-256 해시 체인으로 묶은 감사 원장 화면
...
운영 도구답게 과한 마케팅 히어로보다 반복 작업에 맞는 콘솔 UI를 우선했습니다. 모든 핵심 증거는 평가자가 클릭해서 확인할 수 있게 화면별로 분리했습니다.
