...
15. Web requests render the grounded answer, document match, sources, confidence, review reasons, permission audit, trace summary, proof packet, and tool calls in the console.
16. Slack requests are formatted into thread replies. Real posting is controlled by `SLACK_POST_REPLIES`.
