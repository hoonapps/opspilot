...
생성 시각: 2026-06-17T17:35:54.853Z
...
| --- | --- | ---: | --- | --- | --- |
| 근거 기반 장애 답변 | public/payment-error-codes.md<br>public/index-quality-proof.md<br>github/hoonapps/opspilot/permission-boundary.md<br>github/hoonapps/opspilot/runbook-example.md<br>github/hoonapps/opspilot/design.md | 100% (1.000, 17/17 토큰) | search_documents:allowed | 필요 | 통과 결제 에러 문서가 1순위 출처<br>통과 출처 1개 이상 포함<br>통과 검색 도구 호출 저장 |
| 새 Markdown 색인 | public/status-page-policy.md<br>public/quality-gate-proof.md<br>public/retrieval-robustness-proof.md<br>public/agreement-smoke-policy.md<br>github/hoonapps/opspilot/deployment.md | 100% (1.000, 25/25 토큰) | search_documents:allowed | 불필요 | 통과 문서 등록 후 청크 생성<br>통과 새 문서가 1순위 출처<br>통과 답변에 15분 기준 포함 |
...
- 답변 ID: `705c6640-b652-4c1d-836c-e2b78dabc954`
- 출처 수: 5
